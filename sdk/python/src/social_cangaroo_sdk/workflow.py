...
if TYPE_CHECKING:
    ...
    from .client import SocialCangarooClient
...
class Workflow:
    ...
    def __init__(self, *, client: SocialCangarooClient, name: str = "", description: str = ""):
        self._client = client
        self.name = name
    ...
    def add_typed(
        ...
        *,
        ...
        `social_cangaroo_sdk.typed` instead of string+kwargs.
