...
export type ClientOptions = {
    baseUrl: 'https://app.socialcangaroo.com' | 'http://localhost:8000' | (string & {});
};
...
export type AriConfigurationRequest = {
     ...
     * Ws Client Name
     *
     * websocket_client.conf connection name for externalMedia (e.g., social_cangaroo_staging)
     */
...
export type ByokPipelineAiModelConfiguration = {
    ...
    embeddings?: ({
        ...
        provider: 'dograh';
    } & SocialCangarooEmbeddingsConfiguration) | null;
};
...
export type DailyUsageBreakdownResponse = {
    ...
    /**
     * Total Social Cangaroo Tokens
     */
    total_social_cangaroo_tokens: number;
    /**
     * Currency
     */
    currency?: string | null;
...
export type DailyUsageItem = {
    ...
    /**
     * Social Cangaroo Tokens
     */
    social_cangaroo_tokens: number;
    /**
     * Call Count
     */
    call_count: number;
 ...
 * Social Cangaroo
 */
export type SocialCangarooEmbeddingsConfiguration = {
    /**
     * Provider
     */
    provider?: 'dograh';
     ...
     * Model
     *
     * Social-Cangaroo-managed embedding model.
     */
    model?: string;
};
 ...
 * Social Cangaroo
 */
export type SocialCangarooLlmService = {
    /**
     * Provider
     */
    provider?: 'dograh';
     ...
     * Model
     *
     * Social-Cangaroo-hosted model tier.
     */
    model?: string;
};
 ...
 */
export type SocialCangarooManagedAiModelConfiguration = {
    /**
     * Api Key
     */
    api_key: string;
 ...
 * Social Cangaroo
 */
export type SocialCangarooSttService = {
    /**
     * Provider
     */
    provider?: 'dograh';
 ...
 * Social Cangaroo
 */
export type SocialCangarooTtsService = {
    /**
     * Provider
     */
    provider?: 'dograh';
...
export type GoogleTtsConfiguration = {
     ...
     * Model
     *
     * Google Cloud low-latency TTS engine. Social Cangaroo maps this to Pipecat's streaming Google TTS service for Chirp 3 HD and Journey voices.
     */
    model?: string;
    /**
     * Voice
...
export type HttpApiConfig = {
     ...
     * Preset Parameters
     *
     * Parameters injected by Social Cangaroo from fixed values or workflow context templates.
     */
...
export type HttpTransferResolverConfig = {
     ...
     * Wait Message
     *
     * Optional short message played while Social Cangaroo resolves routing.
     */
...
export type ModelConfigurationPricingResponse = {
    ...
    social_cangaroo_model?: ModelConfigurationMetricPrice | null;
};
...
export type OrganizationAiModelConfigurationV2 = {
     ...
     */
    mode: 'dograh' | 'byok';
    dograh?: SocialCangarooManagedAiModelConfiguration | null;
...
export type WorkflowRunUsageResponse = {
    ...
    created_at: string;
    /**
     * Social Cangaroo Token Usage
     */
    social_cangaroo_token_usage: number;
    /**
...
export type ActiveCallsApiV1HealthActiveCallsGetData = {
    ...
    headers?: {
        /**
         * X-Social-Cangaroo-Devops-Secret
         */
        'X-Social-Cangaroo-Devops-Secret'?: string | null;
    };
    path?: never;
    query?: never;
