...
export type ClientOptions = {
    baseUrl: 'https://aicall.rilt.ai' | 'http://localhost:8000' | (string & {});
};
...
export type AriConfigurationRequest = {
     ...
     * Ws Client Name
     *
     * websocket_client.conf connection name for externalMedia (e.g., rilt_staging)
     */
...
export type ByokPipelineAiModelConfiguration = {
    ...
    embeddings?: ({
        ...
        provider: 'dograh';
    } & RiltEmbeddingsConfiguration) | null;
};
...
export type GoogleTtsConfiguration = {
     ...
     * Model
     *
     * Google Cloud low-latency TTS engine. AICall maps this to Pipecat's streaming Google TTS service for Chirp 3 HD and Journey voices.
     */
    model?: string;
    /**
     * Voice
...
export type HttpApiConfig = {
     ...
     * Preset Parameters
     *
     * Parameters injected by AICall from fixed values or workflow context templates.
     */
...
export type HttpTransferResolverConfig = {
     ...
     * Wait Message
     *
     * Optional short message played while AICall resolves routing.
     */
...
export type ModelConfigurationPricingResponse = {
    ...
    rilt_model?: ModelConfigurationMetricPrice | null;
};
...
export type OrganizationAiModelConfigurationV2 = {
     ...
     */
    mode: 'dograh' | 'byok';
    dograh?: RiltManagedAiModelConfiguration | null;
...
export type ActiveCallsApiV1HealthActiveCallsGetData = {
    ...
    headers?: {
        /**
         * X-Rilt-Devops-Secret
         */
        'X-Rilt-Devops-Secret'?: string | null;
    };
    path?: never;
    query?: never;
