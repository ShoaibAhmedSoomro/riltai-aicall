"""Tests for the Python runtime SDK (`rilt_sdk`).
...
import pytest
from rilt_sdk import Workflow
from rilt_sdk._generated_models import NodeSpec
from rilt_sdk.errors import ValidationError
...
class _StubClient:
    """Stand-in for RiltClient backed by the in-process spec registry.
