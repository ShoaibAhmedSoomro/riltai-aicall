"""Tests for the Python runtime SDK (`social_cangaroo_sdk`).
...
import pytest
from social_cangaroo_sdk import Workflow
from social_cangaroo_sdk._generated_models import NodeSpec
from social_cangaroo_sdk.errors import ValidationError
...
class _StubClient:
    """Stand-in for SocialCangarooClient backed by the in-process spec registry.
