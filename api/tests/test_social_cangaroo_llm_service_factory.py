...
def test_create_social_cangaroo_llm_service_passes_variable_extraction_usage_context():
    ...
    ) as social_cangaroo_llm_service:
        create_llm_service(
            user_config,
    ...
    kwargs = social_cangaroo_llm_service.call_args.kwargs
