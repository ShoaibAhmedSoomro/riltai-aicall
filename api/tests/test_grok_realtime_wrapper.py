...
def _make_service() -> SocialCangarooGrokRealtimeLLMService:
    service = SocialCangarooGrokRealtimeLLMService(api_key="test-key")
...
def test_factory_creates_social_cangaroo_grok_realtime_service():
    ...
    assert isinstance(service, SocialCangarooGrokRealtimeLLMService)
