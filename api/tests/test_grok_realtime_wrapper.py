...
def _make_service() -> RiltGrokRealtimeLLMService:
    service = RiltGrokRealtimeLLMService(api_key="test-key")
...
def test_factory_creates_rilt_grok_realtime_service():
    ...
    assert isinstance(service, RiltGrokRealtimeLLMService)
