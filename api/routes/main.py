...
async def active_calls(
    x_rilt_devops_secret: Annotated[
        str | None,
        Header(alias=RILT_DEVOPS_SECRET_HEADER),
    ] = None,
) -> ActiveCallsResponse:
