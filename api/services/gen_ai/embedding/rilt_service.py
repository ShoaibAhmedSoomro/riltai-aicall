"""RiltAI-managed embedding service.

Routes embeddings through AICall's managed proxy (MPS). This mirrors the managed
voice services (``RiltLLMService`` / ``RiltTTSService``): when a server-minted
...
class RiltEmbeddingService(OpenAIEmbeddingService):
    """OpenAI-compatible embedding client pointed at AICall's managed proxy."""
    ...
    def __init__(
        ...
        Args:
            ...
            api_key: RiltAI-managed MPS service key.
