"""Social-Cangaroo-managed embedding service.

Routes embeddings through Social Cangaroo's managed proxy (MPS). This mirrors the managed
voice services (``SocialCangarooLLMService`` / ``SocialCangarooTTSService``): when a server-minted
...
class SocialCangarooEmbeddingService(OpenAIEmbeddingService):
    """OpenAI-compatible embedding client pointed at Social Cangaroo's managed proxy."""
    ...
    def __init__(
        ...
        Args:
            ...
            api_key: Social-Cangaroo-managed MPS service key.
