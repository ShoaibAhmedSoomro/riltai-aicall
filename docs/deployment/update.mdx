...
```bash
cd rilt
curl -o update_remote.sh https://raw.githubusercontent.com/ShoaibAhmedSoomro/rilt/main/scripts/update_remote.sh
...
<CodeGroup>
```bash macOS/Linux
curl -o docker-compose.yaml https://raw.githubusercontent.com/ShoaibAhmedSoomro/rilt/main/docker-compose.yaml
curl -o start_docker.sh https://raw.githubusercontent.com/ShoaibAhmedSoomro/rilt/main/scripts/start_docker.sh && chmod +x start_docker.sh
docker compose down
./start_docker.sh
```
```powershell Windows
Invoke-WebRequest -OutFile docker-compose.yaml https://raw.githubusercontent.com/ShoaibAhmedSoomro/rilt/main/docker-compose.yaml; Invoke-WebRequest -OutFile start_docker.ps1 https://raw.githubusercontent.com/ShoaibAhmedSoomro/rilt/main/scripts/start_docker.ps1; docker compose down; .\start_docker.ps1
```
</CodeGroup>
