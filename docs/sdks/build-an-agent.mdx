...
description: "Assemble a Social Cangaroo voice agent programmatically with the SDK and save it as a draft"
---
...
- An existing agent ID to save drafts against (create one in the Social Cangaroo UI or via [`POST /api/v1/workflow/create`](/api-reference/agents/create-from-template))
