...
If your team is manually dialing leads one by one, or your CRM needs to kick off a call the moment a lead comes in, this is how you automate that with Social Cangaroo.
...
```bash
curl -X POST https://api.socialcangaroo.com/api/v1/public/agent/test/{uuid} \
