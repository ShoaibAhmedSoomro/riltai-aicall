...
<iframe
  ...
  title="How to Build Your First Voice Agent in Social Cangaroo"
  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
  allowFullScreen
></iframe>

<Note>
Using the hosted platform, go to [app.socialcangaroo.com](https://app.socialcangaroo.com). Self-hosting locally? Use `http://localhost:3010` instead, and follow [Getting Started](/getting-started) first to get the platform running.
</Note>

## Step 1: Create an agent

Go to [app.socialcangaroo.com/workflow](https://app.socialcangaroo.com/workflow) and create a new agent.
