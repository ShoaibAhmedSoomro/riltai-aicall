---
title: "Prerequisites"
description: "System requirements and setup needed to run Social Cangaroo AI locally"
---
...
To run Social Cangaroo AI locally, make sure you have the following installed:
...
Social Cangaroo images are available from two registries:

- **GitHub Container Registry (Default)**: `ghcr.io/ShoaibAhmedSoomro` - Recommended for most users
- **Docker Hub**: `socialcangaroo` - Alternative registry
...
REGISTRY=ghcr.io/ShoaibAhmedSoomro ./start_docker.sh

# Using Docker Hub
REGISTRY=socialcangaroo ./start_docker.sh
```
```powershell Windows
# Using GitHub Container Registry (recommended)
$env:REGISTRY = 'ghcr.io/ShoaibAhmedSoomro'; .\start_docker.ps1

# Using Docker Hub
$env:REGISTRY = 'socialcangaroo'; .\start_docker.ps1
```
</CodeGroup>
