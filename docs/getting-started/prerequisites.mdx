---
title: "Prerequisites"
description: "System requirements and setup needed to run AICall locally"
---
...
To run AICall locally, make sure you have the following installed:
...
# Using Docker Hub
REGISTRY=riltai ./start_docker.sh
```
```powershell Windows
# Using GitHub Container Registry (recommended)
...
# Using Docker Hub
$env:REGISTRY = 'riltai'; .\start_docker.ps1
```
</CodeGroup>
