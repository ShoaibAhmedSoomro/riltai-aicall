...
Social Cangaroo platform supports Deepgram, OpenAI, Google, Azure Speech, AssemblyAI, Speechmatics, Cartesia, Gladia, Sarvam, Smallest AI, Hugging Face, ElevenLabs, and Social Cangaroo transcribers. You can take a look at the providers documentation of which language to select for your language requirements. 
...
For locally deployed or self-hosted STT models, Social Cangaroo also supports Speaches, an OpenAI API-compatible server for streaming transcription.
