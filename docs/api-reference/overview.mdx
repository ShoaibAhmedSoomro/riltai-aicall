---
title: "Overview"
description: "Interact with AICall programmatically via the REST API"
---
...
```
https://your-rilt-instance/api/v1
```

If you are using the hosted version, the base URL is `https://aicall.rilt.ai/api/v1`.
...
```bash
curl -X POST https://your-rilt-instance/api/v1/workflow/create/definition \
...
```bash
curl https://your-rilt-instance/api/v1/health
```
...
```json
{
  "status": "ok",
  "version": "1.0.0",
  "backend_api_endpoint": "https://your-rilt-instance",
  "deployment_mode": "oss",
  "auth_provider": "local"
}
```
