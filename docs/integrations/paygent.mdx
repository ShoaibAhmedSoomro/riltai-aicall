...
description: "Connect Social Cangaroo to Paygent — real-time cost tracking, multimodal usage monitoring, and billing for voice agents"
---

<iframe
  width="100%"
  height="400"
  src="https://www.youtube.com/embed/XCToP3SqS8I"
...
Instead of building custom tracking infrastructure, you simply connect your Social Cangaroo workflow to Paygent. As your agents handle calls, Social Cangaroo passively calculates the exact multimodal token usage and audio duration. 
...
- A Social Cangaroo voice agent workflow

## Setup

### 1. Create an agent and configure pricing in Paygent

Before connecting Social Cangaroo, you must register your agent in Paygent and define how you want to charge your customers.
...
Next, set the **Indicator Name**. This is the billing event identifier you will pass from Social Cangaroo (e.g. `per-minute-call`) to tell Paygent which rate to apply for this agent's calls:
...
Once your pricing is configured, confirm your setup. You will use the **Agent ID** and **Indicator** from this process to connect your Social Cangaroo workflow.

### 2. Gather your Paygent credentials

You'll need three core values from your Paygent dashboard to link your Social Cangaroo agent:
...
In your Social Cangaroo workflow editor, click **Add node** and scroll to the **Integrations** section. Select **Paygent**. The node will appear on your canvas with a **Not configured** badge.
