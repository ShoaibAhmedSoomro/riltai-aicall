...
1. Fork [ShoaibAhmedSoomro/rilt](https://github.com/ShoaibAhmedSoomro/riltai-aicall) and clone **your fork**:
...
<AccordionGroup>
<Accordion title="Cloned ShoaibAhmedSoomro/rilt directly instead of your fork?">
Run `bash scripts/setup_fork.sh` once. It prompts for your fork URL, points `origin` at it, and adds `upstream` as `ShoaibAhmedSoomro/rilt`. See [Fork and upstream remotes](/contribution/reference#fork-and-upstream-remotes).
</Accordion>
...
2. Push to your fork (`origin`) and open a pull request against `ShoaibAhmedSoomro/rilt:main`.
